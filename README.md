...
The code in this repository is released under the [MIT](https://github.com/shahrukhali1/Portfolio) License, which grants you the freedom to use, modify, and distribute the template as your own. However, if you choose to use the site's design largely unmodified, kindly credit me as the original designer of the site.
...
- [Download the ZIP file from this location](https://github.com/shahrukhali1/Portfolio) or run the following [git](https://github.com/shahrukhali1/Portfolio) command to clone the files to your machine:

```
git clone git@github.com:shahrukhali1/Portfolio.git
```
